...
source_url: "https://developers.google.com/search/docs/monitor-debug/prevent-abuse?hl=en"
product: "Google Search Central"
section: "Docs / Monitor & Debug"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/monitor-debug/prevent-abuse.md"
---
...
* Monitor your property for spam signals such as redirects, large numbers of ad sections,
  ...
  [`site:`](/search/docs/monitor-debug/search-operators/all-search-site)
  search operator or
...
* Monitor your property for phishing and malware-infected pages. For example, you can use the
  [Google Safe Browsing API](/safe-browsing)
