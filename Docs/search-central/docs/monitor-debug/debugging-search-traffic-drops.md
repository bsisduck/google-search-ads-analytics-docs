...
source_url: "https://developers.google.com/search/docs/monitor-debug/debugging-search-traffic-drops?hl=en"
product: "Google Search Central"
section: "Docs / Monitor & Debug"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/monitor-debug/debugging-search-traffic-drops.md"
---
...
* **[Small drop in position?](#small)** For example, dropping from position 2 to 4.
* **[Large drop in position?](#large)** For example, dropping from position 4 to 29.
...
[continue to rank well with our systems](/search/updates/core-updates).
...
![Date range filter showing Last 16 months in the Performance report in Search Console](/static/search/docs/images/performance-report-date-range.png)
...
![Yearly seasonality in the Performance report in Search Console](/static/search/docs/images/yearly-seasonality-chart.png)
...
![Date range filter comparison](/static/search/docs/images/search-console-date-range-filter-comparison.png)
...
![Comparison mode on Performance report showing drop in traffic](/static/search/docs/images/search-traffic-drop-comparison.png)
...
![Search type filter in the Performance report in Search Console](/static/search/docs/images/performance-search-type-filter.png)
...
![Average position decline in the Performance report in Search Console](/static/search/docs/images/search-average-position-decline.png)
...
![Page comparison in the Performance report in Search Console](/static/search/docs/images/search-console-performance-page-comparison.png)
...
2. **[Seasonality](https://en.wikipedia.org/wiki/Seasonality)**.
   For example, the [rhythm of food website](https://rhythm-of-food.net/)
...
![Trends for turkey, chicken and coffee in Google Trends](/static/search/docs/images/google-trends-analysis.png)
