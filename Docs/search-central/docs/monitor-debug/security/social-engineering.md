...
source_url: "https://developers.google.com/search/docs/monitor-debug/security/social-engineering?hl=en"
product: "Google Search Central"
section: "Docs / Monitor & Debug"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/monitor-debug/security/social-engineering.md"
---
...
* **[Phishing](https://support.google.com/websearch/answer/106318):**
  The site tricks users into revealing their personal information (for example, passwords,
...
* **Insufficiently labeled third-party services:** A *third-party service*
  is someone that operates a site or service on behalf of another entity. If you (third party)
...
correct, and also check to see that the website begins with `https://`.
...
1. **Check in Search Console**.
   * [Verify that you own your site in Search Console](https://support.google.com/webmasters/answer/2739618)
...
2. **Remove deceptive content**. Ensure that none of your site's pages contain
   ...
   [report it](https://www.google.com/safebrowsing/report_error/).
3. **Check the third-party resources included in your site**. Ensure that any ads, images, or
   ...
   * Follow the [third-party service guidelines](#third-party-guidelines) for any third-party services,
     such as payment services, that you use in your site.
4. **Request a review**. After you remove all social engineering content from your site, you can
   [request a security review](https://support.google.com/webmasters/answer/9044101#fix)
...
* On every page that contains first-party branding, explicitly state the relationship between
  ...
  *This service is hosted by Example.com on behalf of Example.charities.com. More
  information.*
...
**Best practice:** If you need a third party to perform a basic support service
...
[OAuth](https://oauth.net/) rather than managing authentication
yourself.
