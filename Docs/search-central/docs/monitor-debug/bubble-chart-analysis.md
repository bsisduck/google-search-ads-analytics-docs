...
source_url: "https://developers.google.com/search/docs/monitor-debug/bubble-chart-analysis?hl=en"
product: "Google Search Central"
section: "Docs / Monitor & Debug"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/monitor-debug/bubble-chart-analysis.md"
---
...
![Elements in the Search Console bubble chart](/static/search/docs/images/search-console-bubble-chart.png)
...
2. **Date range**: Choose the date range you'd like to see in the report; by default you'll see
   the last 28 days.
3. **Query**: Include or exclude queries to focus on. You can [filter your data](/search/blog/2021/06/regex-negative-match)
...
6. **Reverse y-axis direction**: Since the y-axis shows average position,
...
7. **Log scale**: Using a [logarithmic scale](https://en.wikipedia.org/wiki/Logarithmic_scale)
...
8. **[Reference lines](https://support.google.com/datastudio/answer/9921462)**:
...
![Bubble chart showing four types of query performance](/static/search/blog/images/query-performance-types.png)
...
4. **Top position, low CTR**: Those queries might have a low CTR for various reasons. Check the
   ...
   * Your competitors may have [structured data markup](/search/docs/appearance/search-result-features)
     ...
     [visual elements in Google Search](/search/docs/appearance/visual-elements-gallery).
...
* Ensure that your [title](/search/docs/appearance/title-link#page-titles) elements,
  [description meta tags](/search/docs/appearance/snippet#meta-descriptions), and alt
...
* Think about other words that a user might search for to find a piece of your content, for
  ...
  [use Google Trends](/search/docs/monitor-debug/google-trends) to find ideas
