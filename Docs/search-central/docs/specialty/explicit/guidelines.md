...
source_url: "https://developers.google.com/search/docs/specialty/explicit/guidelines?hl=en"
product: "Google Search Central"
section: "Docs / Specialty Sites"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/specialty/explicit/guidelines.md"
---
...
**Is your site being incorrectly flagged as explicit?** Check our [troubleshooting guide](/search/docs/specialty/explicit/troubleshooting)
...
[content policies](https://support.google.com/websearch/answer/10622781) (such as child
sexual abuse material). We also remove pages upon user request for
[personal information removal](https://support.google.com/websearch/troubleshooter/3111061)
(for example content involving [explicit personal imagery created or shared without consent](https://support.google.com/websearch/answer/6302812),
...
* **Explicit personal information removals**: We demote all pages from sites that receive a
  ...
  [explicit personal imagery created or shared without consent](https://support.google.com/websearch/answer/6302812)
  or [explicit non-consensual fake content](https://support.google.com/websearch/answer/9116649).

For more information on our ranking systems, check out our [removal-based demotion systems](/search/docs/appearance/ranking-systems-guide#removals)
and [spam policies](/search/docs/essentials/spam-policies#other-behaviors-that-can-lead-to-demotion-or-removal).
...
Allowing Googlebot to [fetch your video files](/search/docs/appearance/video#allow-fetch)
...
requests to your server [really are from Google](/search/docs/crawling-indexing/verifying-googlebot).
...
[verifying Googlebot requests](/search/docs/crawling-indexing/verifying-googlebot) and
...
To mark a particular page as explicit, add [rating markup](/search/docs/crawling-indexing/special-tags#rating)
with the `adult` value either as a
[`meta` tag](/search/docs/crawling-indexing/special-tags#rating) or an HTTP response header.
...
tag in your video sitemap](/search/docs/crawling-indexing/sitemaps/video-sitemaps#family-friendly). You only need to use this tag (set to `no`) for
