...
source_url: "https://developers.google.com/search/docs/specialty/ecommerce/share-your-product-data-with-google?hl=en"
product: "Google Search Central"
section: "Docs / Specialty Sites"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/specialty/ecommerce/share-your-product-data-with-google.md"
---
...
* **Include structured data in your site's product pages**.
  ...
  [adding structured data to your web pages](#add-structured-data).
* **Tell Google directly which products you want to show on Google**
  ...
  Learn more about the [benefits of Google Merchant Center](#upload-product-data).
...
* Structured data increases eligibility for
  [Product rich results](/search/docs/appearance/structured-data/product).
