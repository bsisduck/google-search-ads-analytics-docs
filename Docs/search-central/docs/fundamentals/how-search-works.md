...
source_url: "https://developers.google.com/search/docs/fundamentals/how-search-works?hl=en"
product: "Google Search Central"
section: "Docs / SEO Fundamentals"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/fundamentals/how-search-works.md"
---
...
[How Search Works site](https://www.google.com/search/howsearchworks/),
...
1. [**Crawling:**](#crawling) Google downloads text, images, and videos
   from pages it found on the internet with automated programs called crawlers.
2. [**Indexing:**](#indexing) Google analyzes the text, images, and
   video files on the page, and stores the information in the Google index, which is a large
   database.
3. [**Serving search results:**](#serving) When a user searches on
...
[Learn more about ads on Google Search](https://www.google.com/search/howsearchworks/our-approach/ads-on-search/).
