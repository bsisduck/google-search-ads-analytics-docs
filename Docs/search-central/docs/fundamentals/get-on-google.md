---
title: "Get your website on Google"
source_url: "https://developers.google.com/search/docs/fundamentals/get-on-google?hl=en"
product: "Google Search Central"
section: "Docs / SEO Fundamentals"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/fundamentals/get-on-google.md"
---
...
can find additional getting started information in the [SEO Starter Guide](/search/docs/fundamentals/seo-starter-guide).

### Is your website showing up on Google?

To see if your pages are already [indexed](/search/docs/fundamentals/how-search-works#indexing),
...
under the prefix specified in the query. [Learn more about the `site:` operator](/search/docs/monitor-debug/search-operators/all-search-site).
...
* **Your site isn't linked to by other sites on the web.** See if you can get
  ...
  considered a [violation of Google's spam policies](/search/docs/essentials/spam-policies#link-spam)).
* **You've just launched a new site and Google hasn't had time to [crawl](/search/docs/fundamentals/how-search-works#crawling) it yet.** It can take a
...
* **Google missed it:** Although Google crawls billions of pages, it's inevitable
  ...
  understanding your site. You can also [send us your most important URLs](/search/docs/crawling-indexing/ask-google-to-recrawl)
  to let us know we should crawl and potentially index them.

Follow the [Google Search Essentials](/search/docs/essentials) to make sure that you're fulfilling the site guidelines for appearing on Google.
...
[creating content that's helpful, reliable, and people-first](/search/docs/fundamentals/creating-helpful-content).
To make sure that you're managing your website using Google-friendly
practices, read the [Search Essentials](/search/docs/essentials).
...
increase visibility on search engines. Learn more about [why and how to hire an SEO](/search/docs/fundamentals/do-i-need-seo).
...
Business or person | || [**Google for Retail**](https://www.google.com/ads/shopping/index.html) | To promote your products on Google Shopping, Google Offers, and other properties, you can submit your product catalogs digitally to Google Search. |
...
Digital content | || [**Google Books and eBooks**](https://support.google.com/books/partner/answer/3324395) | Promote your books online and sell your titles through our eBook store. |
...
Local information | || [**Google Maps Content Partners**](https://contentpartners.maps.google.com/) | If you are an authoritative or official source of regional data, publish it through Google. |
...
Media | || [**Google Maps Content Partners**](https://contentpartners.maps.google.com/) | If you are an authoritative or official source of regional data, publish it through Google. |
| [**Video on Google Search**](/search/docs/appearance/video) | Make your videos findable and crawlable by Google Search. |
