...
source_url: "https://developers.google.com/search/docs/fundamentals/get-started-developers?hl=en"
product: "Google Search Central"
section: "Docs / SEO Fundamentals"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/fundamentals/get-started-developers.md"
---
...
[SEO starter guide](/search/docs/fundamentals/seo-starter-guide). The SEO
starter guide covers other aspects of SEO, like authoring content.
...
![A website that shows 6 different images of cats. The title of the website
                  is Cute cat content chronicles.](/static/search/docs/images/get-started01.png)
...
![A website that shows the title of the website. There are supposed to be images of cats on the page, but it just shows loading icons.](/static/search/docs/images/get-started02.png)
...
* Use [`<a>` elements that Google can crawl](/search/docs/crawling-indexing/links-crawlable#crawlable-links).
...
* **Make sure that every page has a
  ...
  [meta description](/search/docs/appearance/snippet#meta-descriptions)**.
...
* **Make sure your text content is accessible in the
  ...
  For example, content that is added via the [CSS `content` property](https://developer.mozilla.org/en-US/docs/Web/CSS/content)
...
* To block Googlebot from crawling your page,
  [create a robots.txt](/search/docs/crawling-indexing/robots/create-robots-txt).
  A robots.txt is not a mechanism for keeping a web page out of Google. To
  keep a web page out of Google, use the `noindex` robots rules, or
  [password-protect](/search/docs/crawling-indexing/control-what-you-share) your page.
* To block Google from indexing your page but still allow crawling,
  [add a
  `noindex` tag](/search/docs/crawling-indexing/robots-meta-tag#noindex).
  Combining multiple crawling and indexing rules might cause some
  rules to counteract other rules. Learn how to configure these rules properly
  by reading
  [Combining crawling with indexing / serving rules](/search/docs/crawling-indexing/robots-meta-tag#combining).
...
* [Test your robot.txt](https://support.google.com/webmasters/answer/6062598)
...
![A carousel of recipes in search results](/static/search/docs/images/recipe-host-carousel-rich-result.png)
