...
source_url: "https://developers.google.com/search/docs/crawling-indexing/troubleshoot-crawling-errors?hl=en"
product: "Google Search Central"
section: "Docs / Crawling & Indexing"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/crawling-indexing/troubleshoot-crawling-errors.md"
---
...
* **Block pages from crawling if you don't want them to be crawled.** (See *[manage
  your inventory](/crawling/docs/crawl-budget#manage_inventory)*)
* **Increase page loading and rendering speed.** (See *[Improve
  your site's crawl efficiency](#improve_crawl_efficiency)*)
...
3. Review your crawling priorities (a.k.a. use your crawl budget wisely). [Manage
   your inventory](/crawling/docs/crawl-budget#manage_inventory) and [improve your site's crawling efficiency](#improve_crawl_efficiency).
4. [Check that you're not running out of serving capacity](#availability_issues).
...
* Use a [news sitemap](/search/docs/crawling-indexing/sitemaps/news-sitemap) if your site
  has news content.
* Use the `<lastmod>` tag in sitemaps to indicate when an indexed URL has
  been updated.
* Use a [crawlable URL structure](/search/docs/crawling-indexing/url-structure) to help Google find your pages.
* Provide standard, [crawlable `<a>` links](/search/docs/crawling-indexing/links-crawlable#crawlable-links)
...
* If your site uses separate HTML for mobile and desktop versions, provide the same set of links
  ...
  [sitemap](/search/docs/crawling-indexing/sitemaps/overview) file.
  Google only
  [indexes the
  mobile version](/search/docs/crawling-indexing/mobile/mobile-sites-mobile-first-indexing) of pages, and limiting the links shown there
...
* Including URLs in your sitemaps that [you don't want to appear in Search](#hide_urls).
...
[AdsBot](/search/docs/crawling-indexing/overview-google-crawlers#adsbot) is more
...
* [Faceted navigation](/search/docs/crawling-indexing/crawling-managing-faceted-navigation)
  and [session identifiers](/search/blog/2007/09/google-duplicate-content-caused-by-url):
  ...
  [manage crawling of faceted navigation pages](/search/docs/crawling-indexing/crawling-managing-faceted-navigation).
* [Duplicate content](/search/docs/crawling-indexing/consolidate-duplicate-urls):
  Help Google identify duplicate content to avoid unnecessary crawling.
* [`soft 404` pages](#soft-404-errors): Return a `404`
  code when a page no longer exists.
* [Hacked pages](/search/docs/monitor-debug/security/what-is-hacked): Be sure to check
  the [Security
...
* [Low quality and spam content](/search/docs/essentials/spam-policies):
...
4. If the problematic crawler is one of the
   [AdsBot crawlers](/search/docs/crawling-indexing/google-special-case-crawlers#adsbot-mobile-web),
