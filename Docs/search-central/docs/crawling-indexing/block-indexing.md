...
source_url: "https://developers.google.com/search/docs/crawling-indexing/block-indexing?hl=en"
product: "Google Search Central"
section: "Docs / Crawling & Indexing"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/crawling-indexing/block-indexing.md"
---
...
**Important**: For the `noindex` rule to be effective, the page
...
`noindex` rule, and the page can still appear in search results, for example
