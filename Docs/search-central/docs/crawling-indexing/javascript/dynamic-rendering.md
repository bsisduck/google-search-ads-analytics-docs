...
source_url: "https://developers.google.com/search/docs/crawling-indexing/javascript/dynamic-rendering?hl=en"
product: "Google Search Central"
section: "Docs / Crawling & Indexing"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/crawling-indexing/javascript/dynamic-rendering.md"
---
...
![A diagram that shows how dynamic rendering works. The diagram shows the server serving
          ...
          renderer serves static HTML to the crawler.](/static/search/docs/images/how-dynamic-rendering-works.png)
