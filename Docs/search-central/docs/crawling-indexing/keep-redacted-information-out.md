...
source_url: "https://developers.google.com/search/docs/crawling-indexing/keep-redacted-information-out?hl=en"
product: "Google Search Central"
section: "Docs / Crawling & Indexing"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/crawling-indexing/keep-redacted-information-out.md"
---
...
* Consider information in the URL or file name itself. Even if a part of a website is
  [blocked by robots.txt](/search/docs/crawling-indexing/robots/intro), the
...
2. Use the [Removals tool](https://support.google.com/webmasters/answer/9689846)
