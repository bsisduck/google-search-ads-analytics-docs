...
source_url: "https://developers.google.com/search/docs/crawling-indexing/url-structure?hl=en"
product: "Google Search Central"
section: "Docs / Crawling & Indexing"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/crawling-indexing/url-structure.md"
---
...
[this section of the SEO Starter Guide](/search/docs/fundamentals/seo-starter-guide#group-topically).
...
* Consider using a [robots.txt file](/search/docs/crawling-indexing/robots/intro) to
  block Googlebot's access to [problematic URLs](#common-issues). Typically, consider
