...
source_url: "https://developers.google.com/search/docs/crawling-indexing/ask-google-to-recrawl?hl=en"
product: "Google Search Central"
section: "Docs / Crawling & Indexing"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/crawling-indexing/ask-google-to-recrawl.md"
---
...
[site move](/search/docs/crawling-indexing/site-move-with-url-changes). A sitemap
can also include additional metadata about alternate language versions, video, image, or
news-specific pages.
[Learn how to create and submit a sitemap.](/search/docs/crawling-indexing/sitemaps/build-sitemap)
