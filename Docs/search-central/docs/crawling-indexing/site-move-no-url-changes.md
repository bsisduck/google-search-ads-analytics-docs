...
source_url: "https://developers.google.com/search/docs/crawling-indexing/site-move-no-url-changes?hl=en"
product: "Google Search Central"
section: "Docs / Crawling & Indexing"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/crawling-indexing/site-move-no-url-changes.md"
---
...
1. **[Prepare the new hosting infrastructure](#hosting-infrastructure)**.
   Upload your content to the new servers or configure your CDN and your origin servers, and
   test it.
2. **[Start the site move](#start-site-move)**. Change the DNS settings of your
...
3. **[Monitor traffic](#monitor)**. Keep tabs on the traffic served by the old
   and new hosting.
4. **[Shut down](#shut-down-old-hosting)**. Shut down the old hosting
...
[Learn how to verify Googlebot](/search/docs/crawling-indexing/verifying-googlebot#use-automatic-solutions).
