...
source_url: "https://developers.google.com/search/docs/essentials/spam-policies?hl=en"
product: "Google Search Central"
section: "Docs / Search Essentials"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/essentials/spam-policies.md"
---
...
* **Page injection**: Sometimes, due to security flaws, hackers are able to add new
  ...
  manipulate search engines or to [attempt phishing](https://support.google.com/websearch/answer/106318).
...
* **Content injection**: Hackers might also try to subtly manipulate existing pages on
  ...
  may be harder for you and your users to spot. This can involve adding [hidden links or hidden text](#hidden-text-and-links)
...
* Requiring a link as part of a Terms of Service, contract, or similar arrangement without
  allowing a third-party content owner the choice of [qualifying the outbound link](/search/docs/crawling-indexing/qualify-outbound-links)
...
or [`rel="sponsored"`](/search/docs/crawling-indexing/qualify-outbound-links#sponsored)
...
* [Malware](/search/docs/monitor-debug/security/malware#what_is_malware) is any
...
* [Unwanted software](/search/docs/monitor-debug/security/malware#what-is-unwanted-software)
  ...
  apps that leak private and personal information without proper disclosure. Site owners should make
  sure they don't violate the
  [Unwanted Software Policy](https://www.google.com/about/company/unwanted-software-policy.html)
  and [follow our guidelines](/search/docs/monitor-debug/security/malware#guidelines).
...
* Copying content from other sites, modify it only slightly (for example, by
  substituting synonyms or using [automated techniques](#scaled-content)),
  and republish it
...
*Third-party content* is content that's created by an entity that's separate
...
* Using affiliate links throughout a page, with [links treated appropriately](#link-spam),
