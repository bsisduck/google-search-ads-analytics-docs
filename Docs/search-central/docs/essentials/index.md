...
source_url: "https://developers.google.com/search/docs/essentials?hl=en"
product: "Google Search Central"
section: "Docs / Search Essentials"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/essentials/index.md"
---
...
* Use words that people would use to look for your content, and place those words in
  prominent locations on the page, such as the [title and main heading](/search/docs/appearance/title-link#page-titles)
  of a page, and other descriptive locations such as [alt text](/search/docs/appearance/google-images#use-descriptive-alt-text)
  and link text.
...
* If you have other content, such as [images](/search/docs/appearance/google-images),
  [videos](/search/docs/appearance/video), [structured data](/search/docs/appearance/structured-data/intro-structured-data),
  and [JavaScript](/search/docs/crawling-indexing/javascript/javascript-seo-basics),
  make sure you're following those specific best practices so that we can understand those parts
  of your page too.
* Enhance [how your site appears](/search/docs/appearance/visual-elements-gallery) on Google Search
...
* If you have content that shouldn't be found in search results or you want to opt out entirely,
  use the appropriate method for [controlling how your content appears in Google Search](/search/docs/crawling-indexing/control-what-you-share).
