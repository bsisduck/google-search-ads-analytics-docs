...
source_url: "https://developers.google.com/search/docs/essentials/technical?hl=en"
product: "Google Search Central"
section: "Docs / Search Essentials"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/essentials/technical.md"
---
...
[`noindex`](/search/docs/crawling-indexing/block-indexing) and allow Google
to crawl the URL.
