...
source_url: "https://developers.google.com/search/docs/appearance/structured-data/paywalled-content?hl=en"
product: "Google Search Central"
section: "Docs / Appearance & Structured Data"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/appearance/structured-data/paywalled-content.md"
---
...
practice of [cloaking](/search/docs/essentials/spam-policies#cloaking), which
violates [spam policies](/search/docs/essentials/spam-policies).
Learn more about
...
* If you don't want the content to be accessible to the browser at the time of serving, choose a
  ...
  client-side JavaScript solution, check our [guidance on using JavaScript to implement paywalled content](/search/docs/crawling-indexing/javascript/fix-search-javascript#paywall).
...
1. Add a class name around each paywalled section of your page. For example:
   ...
   ```
2. Add [`NewsArticle`](/search/docs/appearance/structured-data/article)
   structured data.
3. Add the highlighted JSON-LD structured data to your
   ...
   **Note**: The `cssSelector` references the
   ...
   ```
4. Validate your code using the [Rich Results Test](https://search.google.com/test/rich-results)
...
[`max-snippet` robots `meta` tag](/search/docs/crawling-indexing/robots-meta-tag#max-snippet).
