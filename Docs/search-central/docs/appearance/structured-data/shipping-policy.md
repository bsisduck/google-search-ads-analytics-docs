...
source_url: "https://developers.google.com/search/docs/appearance/structured-data/shipping-policy?hl=en"
product: "Google Search Central"
section: "Docs / Appearance & Structured Data"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/appearance/structured-data/shipping-policy.md"
---
...
[Merchant listing](/search/docs/appearance/structured-data/merchant-listing#merchant-shipping-policy-properties)
...
* We recommend placing shipping policy information on a single page on your site that describes the
  ...
  under the `Organization` structured data type. For more information, see [Organization markup](/search/docs/appearance/structured-data/organization).
* If you have a non-standard shipping policy for a specific product, specify the `OfferShippingDetails` structured data type directly under
  ...
  See [merchant listing markup](/search/docs/appearance/structured-data/merchant-listing) for the subset of properties that are supported for product-level shipping policies.
...
[`ServicePeriod` for
transit times](#shipping-service-transit-time-properties).
...
| `numItems` | `QuantitativeValue`  The range of the number of products in the order for this shipping conditions object, if applicable. See also the list of [`QuantitativeValue`](#shipping-quantitative-value-properties) properties related to the `ShippingConditions` type supported by Google. |
| `orderValue` | `MonetaryAmount`  The range of the cost of the order for this shipping conditions object, if applicable. See also the list of [`MonetaryAmount`](#shipping-conditions-monetary-amount-properties) properties related to the `ShippingConditions` type supported by Google. |
| `shippingDestination` | `DefinedRegion`  Indicates shipping destination, if applicable. See the list of [`DefinedRegion`](#defined-region-properties) properties under the `shippingDestination` property supported by Google. |
| `shippingOrigin` | `DefinedRegion`  Indicates shipping origin, if applicable. See the list of [`DefinedRegion`](#defined-region-properties) properties under the `shippingOrigin` property supported by Google. |
| `seasonalOverride` | `OpeningHoursSpecification`  If applicable, use this property to specify a limited time period for which this shipping conditions object is valid. See also the list of [`OpeningHoursSpecification`](#shipping-seasonal-override-properties) properties supported for the `ShippingConditions` type by Google. |
...
| `weight` | `QuantitativeValue`  The package's weight range for this shipping conditions object, if applicable. See also the list of [`QuantitativeValue`](#shipping-quantitative-value-properties) properties related to the `ShippingConditions` type supported by Google. |
...
[`ServicePeriod`](#shipping-service-handling-time-properties).
Example:
...
| `duration` | `QuantitativeValue`  The number of business days in transit, if applicable. See also the list of [`QuantitativeValue`](#shipping-quantitative-value-properties) properties for transit times supported by Google. |
...
For more information, see [`QuantitativeValue` for handling times](#handling-time-quantitative-value-properties) and
[`QuantitativeValue` for transit times](#transit-time-quantitative-value-properties).
...
[specify shipping costs](#shipping-monetary-amount-properties).

| Required properties | |
| --- | --- |
| `currency` | `Text`  The currency code for the order value in [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) format. |
...
| Required properties | |
| --- | --- |
| `currency` | `Text`  The currency code for the shipping cost in [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) format. |
...
| Recommended properties | |
| --- | --- |
| `validFrom` | `Date`  The first date when the shipping condition is valid, in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format. |
| `validThrough` | `Date`  The last date when the shipping condition is valid, in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format. |
