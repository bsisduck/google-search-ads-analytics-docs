...
source_url: "https://developers.google.com/search/docs/appearance/structured-data/sd-policies?hl=en"
product: "Google Search Central"
section: "Docs / Appearance & Structured Data"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/appearance/structured-data/sd-policies.md"
---
...
* Using structured data *enables* a feature to be present, it does not
  *guarantee* that it will be present. The Google algorithm tailors
  ...
  appropriate than another, or even that a [text result](/search/docs/appearance/visual-elements-gallery#text-result) is best.
* The structured data is not [representative of the main content of the page](#relevance),
...
* The page doesn't meet the guidelines for structured data described on this page, the
  guidelines for a specific structured data feature, the [Search Essentials](/search/docs/essentials),
...
* To make sure that Google Search understands what the main purpose of the page is, include
  ...
  [Recipe structured
  data](/search/docs/appearance/structured-data/recipe) in addition to [Video](/search/docs/appearance/structured-data/video) and
  [Review](/search/docs/appearance/structured-data/review-snippet) structured data. This is an opportunity for that
