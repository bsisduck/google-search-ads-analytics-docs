...
source_url: "https://developers.google.com/search/docs/appearance/structured-data/intro-structured-data?hl=en"
product: "Google Search Central"
section: "Docs / Appearance & Structured Data"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/appearance/structured-data/intro-structured-data.md"
---
...
![How a recipe web page's structured data can influence a rich result in Google Search](/static/search/docs/images/structured-data-explainer.png)
...
**If you use a CMS, such as Wix, WordPress, or Shopify,** you might not be able
...
general guidelines](/search/docs/guides/sd-policies).
...
Be sure to follow the [general structured data guidelines](/search/docs/appearance/structured-data/sd-policies), as well
...
Once you're comfortable with the basics of structured data, explore the [list of structured data features in Google Search](/search/docs/appearance/structured-data/search-gallery)
...
is to run a [before and after test on a few pages on your site](/search/docs/crawling-indexing/website-testing).
