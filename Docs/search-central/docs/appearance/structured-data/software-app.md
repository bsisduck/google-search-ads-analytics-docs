...
source_url: "https://developers.google.com/search/docs/appearance/structured-data/software-app?hl=en"
product: "Google Search Central"
section: "Docs / Appearance & Structured Data"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/appearance/structured-data/software-app.md"
---
...
![Software application rich result in Google Search results](/static/search/docs/images/software-apps.png)**Note**: The actual appearance in search results might be different. You can
...
[`MobileApplication`](https://schema.org/MobileApplication) and [`WebApplication`](https://schema.org/WebApplication).
