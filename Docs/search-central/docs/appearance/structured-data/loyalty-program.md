...
source_url: "https://developers.google.com/search/docs/appearance/structured-data/loyalty-program?hl=en"
product: "Google Search Central"
section: "Docs / Appearance & Structured Data"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/appearance/structured-data/loyalty-program.md"
---
...
* Nest the `MemberProgram` markup under the `Organization` type on the page where you
  ...
  Refer to the [Organization markup](/search/docs/appearance/structured-data/organization) documentation for more information.
...
| `hasTiers` | Repeated `MemberProgramTier`  Defines a tier under a loyalty program. A loyalty program must have at least one tier. See the list of [`MemberProgramTier` properties](#memberprogram-tier-properties) supported by Google. |
