...
source_url: "https://developers.google.com/search/docs/appearance/structured-data/movie?hl=en"
product: "Google Search Central"
section: "Docs / Appearance & Structured Data"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/appearance/structured-data/movie.md"
---
...
In addition to the [Carousel properties](/search/docs/appearance/structured-data/carousel), define
...
| Required properties | |
| --- | --- |
| `image` | `URL` or `ImageObject` An image that represents the movie. Additional image guidelines:   * Image URLs must be   [crawlable and indexable](/search/docs/crawling-indexing/sitemaps/image-sitemaps). * Images must represent the marked up content. * Images must be in .jpg, .png, or .gif format. * Images must have a high resolution and have a 6:9 aspect ratio. While Google can crop images   that are close to a 6:9 aspect ratio, images largely deviating from this ratio aren't   eligible for the feature. |
