...
source_url: "https://developers.google.com/search/docs/appearance/structured-data/factcheck?hl=en"
product: "Google Search Central"
section: "Docs / Appearance & Structured Data"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/appearance/structured-data/factcheck.md"
---
Fact check (`ClaimReview`) structured data
==========================================

We're phasing out support for `ClaimReview` markup in Google Search. However, this
...
![Single claim review associated with a page](/static/search/docs/images/factcheck-example-result.png)
...
* You must follow all the [structured data
  guidelines](/search/docs/appearance/structured-data/sd-policies) and [Search Essentials](/search/docs/essentials).
...
* To be eligible for the single fact check rich result, a page must only have one
  `ClaimReview` element. If you add multiple `ClaimReview`
...
* A specific `ClaimReview` must only be on one page on your site. Do
  ...
  versions of a page).
* If your website aggregates fact-check articles, ensure that all articles match the
  [criteria](#guidelines) and that you provide an open and publicly available list of all fact-check websites
  you aggregate.
