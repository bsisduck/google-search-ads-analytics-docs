...
source_url: "https://developers.google.com/search/docs/appearance/structured-data/education-qa?hl=en"
product: "Google Search Central"
section: "Docs / Appearance & Structured Data"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/appearance/structured-data/education-qa.md"
---
...
* **Flashcard page**: A page that contains flashcards that typically have a question on
  ...
  this guide to learn [how to add education Q&A schema](#add-structured-data).
* **Single Q&A page**: A page that only contains one question and is followed by
  ...
  [`QAPage` markup](/search/docs/appearance/structured-data/qapage) instead.
...
| `educationalAlignment` | `AlignmentObject`  The quiz's alignment to an established educational framework. This property can be repeated to align the quiz with a field of study or domain, and the target grade or [educational standard](#mark-up-educational-standards).     ``` {   "@type": "Quiz",   "educationalAlignment": [] } ``` |
...
[Question requirements for `QAPage`](/search/docs/appearance/structured-data/qapage#question).
