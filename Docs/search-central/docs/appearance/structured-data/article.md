...
source_url: "https://developers.google.com/search/docs/appearance/structured-data/article?hl=en"
product: "Google Search Central"
section: "Docs / Appearance & Structured Data"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/appearance/structured-data/article.md"
---
...
[manual action](https://support.google.com/webmasters/answer/2604824) against it.
...
* For multi-part articles, make sure that the `rel=canonical` points at either
  ...
  more about [canonicalization](/search/docs/crawling-indexing/consolidate-duplicate-urls).
