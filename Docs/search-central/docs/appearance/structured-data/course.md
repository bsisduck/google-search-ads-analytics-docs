...
source_url: "https://developers.google.com/search/docs/appearance/structured-data/course?hl=en"
product: "Google Search Central"
section: "Docs / Appearance & Structured Data"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/appearance/structured-data/course.md"
---
...
Here's an example of a single course details page. This page must be paired with a [summary page](/search/docs/appearance/structured-data/carousel#summary-page)
that contains the [`ItemList` markup](#item-list).
...
Here's an example of a [single, all-in-one page](/search/docs/appearance/structured-data/carousel#all-in-one).
...
[detail pages](/search/docs/appearance/structured-data/carousel#details-page), or in
an [all-in-one page](/search/docs/appearance/structured-data/carousel#all-in-one).

You must add [Carousel markup](/search/docs/appearance/structured-data/carousel#details-page)
to either a [summary page](/search/docs/appearance/structured-data/carousel#summary)
or an [all-in-one page](/search/docs/appearance/structured-data/carousel#all-in-one).
...
In addition to [`Course` properties](#course), add the following
properties to specify the list. You can add these properties to either a
[summary page](/search/docs/appearance/structured-data/carousel#summary) or an
[all-in-one page](/search/docs/appearance/structured-data/carousel#all-in-one).
