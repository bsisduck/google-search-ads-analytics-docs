...
source_url: "https://developers.google.com/search/docs/appearance/structured-data/local-business?hl=en"
product: "Google Search Central"
section: "Docs / Appearance & Structured Data"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/appearance/structured-data/local-business.md"
---
...
* [Carousel guidelines](/search/docs/guides/mark-up-listings) (if applicable). The
...
recommend following the fields for [Organization](/search/docs/appearance/structured-data/organization)
