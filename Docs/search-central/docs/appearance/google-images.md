...
source_url: "https://developers.google.com/search/docs/appearance/google-images?hl=en"
product: "Google Search Central"
section: "Docs / Appearance & Structured Data"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/appearance/google-images.md"
---
...
![An illustration that shows images in Google search results, the images tab, and Discover](/static/search/docs/images/images-on-google.png)
...
* Specify the schema.org [`primaryImageOfPage`](https://schema.org/primaryImageOfPage)
  property with a `URL` or `ImageObject`.
...
![An illustration that shows titles and descriptions in image search results](/static/search/docs/images/titles-descriptions-in-image-results.png)
...
![An illustration that shows how rich results can appear in Google Images](/static/search/docs/images/structured-data-in-image-results.png)
...
1. When your image is requested, examine the
   [HTTP referrer header](https://en.wikipedia.org/wiki/HTTP_referer)
   in the request.
