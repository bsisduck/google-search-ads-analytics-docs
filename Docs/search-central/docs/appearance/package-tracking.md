...
source_url: "https://developers.google.com/search/docs/appearance/package-tracking?hl=en"
product: "Google Search Central"
section: "Docs / Appearance & Structured Data"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/appearance/package-tracking.md"
---
...
![package tracking in search results](/static/search/docs/images/package-tracking.png)**Note**: The actual appearance in search results might be different.
...
* Google Package Tracking makes real-time calls (POST requests only) to a RESTful JSON API to
  ...
  [availability and responsiveness requirement](#availability) and provide the
