...
source_url: "https://developers.google.com/search/docs/appearance/favicon-in-search?hl=en"
product: "Google Search Central"
section: "Docs / Appearance & Structured Data"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/docs/appearance/favicon-in-search.md"
---
...
2. Add a `<link>` tag to the header of your [home page](#guidelines)
...
3. Allow time for Google to recrawl and process the new information on your home page. Remember
   ...
   [request indexing](/search/docs/crawling-indexing/ask-google-to-recrawl) of your
...
* Googlebot-Image must be able to crawl the favicon file and Googlebot must be able to crawl the
  ...
  [blocked](/search/docs/crawling-indexing/control-what-you-share)
  for crawling.
