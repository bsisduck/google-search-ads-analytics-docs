...
source_url: "https://developers.google.com/crawling/docs/crawlers-fetchers/overview-google-crawlers?hl=en"
product: "Google Search Central"
section: "Crawler Specs"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/crawling-docs/crawlers-fetchers/overview-google-crawlers.md"
---
...
See our [updates to our documentation](/crawling/docs/changelog).

|  |  |
| --- | --- |
| [Common crawlers](/crawling/docs/crawlers-fetchers/google-common-crawlers) | The common crawlers used for Google's products (such as [Googlebot](/search/docs/crawling-indexing/googlebot)). They always respect robots.txt rules for automatic crawls. |
...
[like Googlebot](/search/docs/crawling-indexing/googlebot) may
...
[reduce the crawl rate](/crawling/docs/crawlers-fetchers/reduce-crawl-rate). Note that
...
* While not required, consider also setting the
  [`max-age` field of the `Cache-Control` response header](https://www.rfc-editor.org/rfc/rfc9111.html#name-max-age-2)
...
[verify Google's crawlers and fetchers](/crawling/docs/crawlers-fetchers/verify-google-requests).
