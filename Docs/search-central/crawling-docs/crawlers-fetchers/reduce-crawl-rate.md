...
source_url: "https://developers.google.com/crawling/docs/crawlers-fetchers/reduce-crawl-rate?hl=en"
product: "Google Search Central"
section: "Crawler Specs"
language: en
scraped_date: 2026-06-08
doc_id: "search-central/crawling-docs/crawlers-fetchers/reduce-crawl-rate.md"
---
...
and
[optimizing crawling efficiency](/search/docs/crawling-indexing/troubleshoot-crawling-errors#improve_crawl_efficiency).
